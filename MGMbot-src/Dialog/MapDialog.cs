...
namespace MGMbot.Dialog
{
    public class MapDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> Center1StepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            var cardJson = File.ReadAllText("./Cards/centerCard.json");
        ...
        private async Task<DialogTurnResult> Center2StepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            if ((string)stepContext.Values["center"] == "서울")
            {
            ...
            else if ((string)stepContext.Values["center"] == "부산")
            {
            ...
            else if ((string)stepContext.Values["center"] == "경기")
            {
            ...
            else if ((string)stepContext.Values["center"] == "강원")
            {
            ...
            else if ((string)stepContext.Values["center"] == "전라")
            {
            ...
            else if ((string)stepContext.Values["center"] == "충청")
            {
            ...
            else if ((string)stepContext.Values["center"] == "경상")
            {
